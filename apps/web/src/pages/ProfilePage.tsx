...
<img alt="User avatar" className="w-full h-full rounded-full object-cover" data-alt="Close up portrait of a smiling young man" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAN-aIj4k7ISl_zpcTQhS3dA8mBRZCRNWLgX1fNAdLIlflKAulXxSbBt8sMFQ8BWw_MuMCkBQP5dOwNIWjC9bm1mO60Pb1DqyNMcmw_f1gwbex8-URtCgt5kIz1LHThKOJXGU7m-Y4teONzr8KPP-qd3DWXmZOJXstdka4Yf3VUemMZsXj3S5dcPh2Ypfw-U7Fwkuat_Y53wxwK9noh3e2KdNiIUy7pjVOI6ZjNQzzU6LsajgHGcLJhY0kSeF5iimQsfHCzZcS9Dq8"/>
</div>
...
<h2 className="text-2xl font-800 text-slate-900 dark:text-white">Alex Nomad</h2>
<p className="text-slate-500 dark:text-slate-400 font-medium">XP: 12,450 / 15,000</p>
</div>
...
<div>
<p className="text-primary font-bold text-sm uppercase tracking-wider">Coin Balance</p>
<p className="text-3xl font-800 text-slate-900 dark:text-white mt-1">2,450 <span className="text-lg">🪙</span></p>
</div>
<button className="bg-primary text-white px-4 py-2 rounded font-bold text-sm">Shop</button>
</div>
</section>
...
<p className="text-xl font-800 text-slate-900 dark:text-white">152</p>
</div>
<div className="bg-white dark:bg-slate-800 p-4 rounded-xl border-2 border-slate-100 dark:border-slate-700 flex flex-col items-center text-center">
...
<p className="text-xl font-800 text-slate-900 dark:text-white">21d</p>
</div>
<div className="bg-white dark:bg-slate-800 p-4 rounded-xl border-2 border-slate-100 dark:border-slate-700 flex flex-col items-center text-center">
<span className="material-symbols-outlined text-yellow-500 mb-2">workspace_premium</span>
<p className="text-xs font-bold text-slate-500 uppercase">Rank</p>
<p className="text-xl font-800 text-slate-900 dark:text-white">#4</p>
</div>
</section>
<section className="mb-8">
<div className="flex items-center justify-between mb-4">
<h3 className="text-lg font-800 text-slate-900 dark:text-white">Badge Collection</h3>
<a className="text-primary font-bold text-sm" href="#">View All</a>
</div>
...
<span className="material-symbols-outlined text-orange-500 text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>emoji_events</span>
</div>
<p className="text-[10px] font-800 text-center text-slate-700 uppercase leading-tight">7 Day Streak</p>
</div>
<div className="flex-shrink-0 w-24 flex flex-col items-center">
<div className="w-20 h-20 rounded-full bg-blue-100 flex items-center justify-center border-4 border-white neo-shadow mb-2">
<span className="material-symbols-outlined text-blue-500 text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>auto_awesome</span>
</div>
<p className="text-[10px] font-800 text-center text-slate-700 uppercase leading-tight">Habit Master</p>
</div>
...
<p className="text-[10px] font-800 text-center text-slate-700 uppercase leading-tight">Early Bird</p>
</div>
</div>
</section>
</main>
<nav className="absolute bottom-0 left-0 right-0 bg-white dark:bg-background-dark border-t border-slate-100 dark:border-slate-800 px-6 py-4 flex justify-between items-center z-10">
...
<span className="text-[10px] font-bold mt-1">Habits</span>
</a>
<a className="flex flex-col items-center text-slate-400" href="#">
